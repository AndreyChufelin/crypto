...
*/
    ...
    "function" == typeof Object.assign
      ...
      : function (a, b) {
          for (let c = 1; c < arguments.length; c++) {
            const d = arguments[c];
            if (d) for (const e in d) u(d, e) && (a[e] = d[e]);
          }
          return a;
        };
  ...
  q("Promise", function (a) {
    ...
    b.prototype.C = function () {
      if (null != this.h) {
        for (let f = 0; f < this.h.length; ++f) g.h(this.h[f]);
        this.h = null;
      }
    };
    var g = new c();
    ...
    b.race = function (f) {
      return new b(function (h, k) {
        for (let m = r(f), n = m.next(); !n.done; n = m.next())
          d(n.value).K(h, k);
      });
    };
    b.all = function (f) {
    ...
    return a
      ...
      : function (b, c) {
          for (var d = [], e = 0; e < this.length; e++) {
            const g = b.call(c, this[e], e, this);
  ...
  const Ma = Array.prototype.some
    ? function (a, b) {
        return Array.prototype.some.call(a, b, void 0);
      }
    : function (a, b) {
        for (
          let c = a.length, d = "string" === typeof a ? a.split("") : a, e = 0;
          e < c;
          e++
        )
  ...
  let L;
  a: {
    const Qa = A.navigator;
    if (Qa) {
      const Ra = Qa.userAgent;
      if (Ra) {
        L = Ra;
        break a;
      }
  ...
  l.forEach = function (a, b) {
    for (let c = this.G(), d = 0; d < c.length; d++) {
      const e = c[d],
        g = this.get(e);
      a.call(b, g, e, this);
    }
  ...
  l.G = function () {
    ...
    for (var a = this.g.H(), b = this.g.G(), c = [], d = 0; d < b.length; d++)
      for (let e = a[d], g = 0; g < e.length; g++) c.push(b[d]);
    return c;
  };
  l.H = function (a) {
    S(this);
  ...
  function zb() {
    ...
    "undefined" === typeof a &&
      ...
      -1 == L.indexOf("Presto") &&
      (a = function () {
        let e = ub(document, "IFRAME");
        e.style.display = "none";
        document.documentElement.appendChild(e);
        const g = e.contentWindow;
        e = g.document;
        e.open();
        e.close();
...
*/
  ...
  function vc(a) {
    ...
    let b = a.get("callback");
    "string" === typeof b && ((b = wc(b)), pc().then(b));
    a = a.get("autoload");
    if ("string" === typeof a)
      try {
        if ("" !== a) {
          const c = JSON.parse(a).modules;
  ...
  const Fc = H("https://maps.googleapis.com/maps/api/js?jsapiRedirect=true"),
    Gc = H(
  ...
  function Hc(a, b, c) {
    ...
    Z = new Promise(function (h) {
      const k = wc(c && c.callback);
      oc(f, {}, g).then(k).then(h);
    });
  }
  const Ic = H("https://www.gstatic.com/inputtools/js/ita/inputtools_3.js");
  function Jc(a, b, c) {
    sa(c) && c.packages
